<template>  
  <el-form label-position="right" label-width="auto" :model="queryWageForm" style="max-width: 600px">
    <el-form-item label="选择员工">
      <el-select  v-model="queryWageForm.id" placeholder="选择员工" style="width: 400px">
        <el-option
    ...
    <el-button type="primary" @click="GetWages()">
      提交
    </el-button>
  </el-form>
...
import { getAllWageList, getWages } from "@/api/wage"
